...
**HeathWiseAI** is an intelligent healthcare web application built using **Streamlit**, combining **Generative AI** and **rule-based logic** to detect potential **water-borne diseases** based on user symptoms.
